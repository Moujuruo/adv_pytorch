...
config = importlib.import_module("model.configs.default1")
network = AdvFaces(config)

state_dict = torch.load('model/assets/obfuscation/task_1_multimodel_drop_ssim_early.pth')
...
# 遍历测试集目录
test_dir = 'test/images_ch1/no_target/images'
